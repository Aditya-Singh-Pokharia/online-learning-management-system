...
import {
  LayoutDashboard, BookOpen, TrendingUp, Award, UserCircle, Camera,
} from 'lucide-react';
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 p-5 sm:p-8 max-w-xl">
        ...
        <p className="text-slate-500 mb-7">Manage your personal information</p>
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-5">
          ...
          <div>
            ...
            <textarea className="input" rows={3} value={bio} onChange={(e) => setBio(e.target.value)} placeholder="Tell us a little about yourself" />
          </div>
